...
// === Hakkımızda (About) Bölümü Çevirileri ===
languages.tr.about = {
...
languages.en.about = {
    ...
    featureSocialText: 'Compete with your friends, get on the leaderboard, and share your achievements.',
    ...
    visionText: 'To become the leading platform in the education technology field in Turkey and a recognized brand worldwide. Through AI-powered personalized learning experiences, we maximize the learning potential of users of all ages.',
    ...
    teamText2: '<strong>Teknova Bilişim</strong> platform of our company, focused on continuously improving the user experience through research and development activities.',
    qualityTitle: 'Quality and Reliability',
    qualityIntro: 'We guarantee the highest quality service for our users:',
    quality1: 'All our questions are prepared and reviewed by expert educators',
    quality2: 'We continuously update our content to ensure accurate and up-to-date information',
...
languages.de.about = {
    title: 'Über Bilgoo',
    subtitle: 'Wir gamifizieren das Lernen, um es spannend und anregend zu machen',
    missionTitle: 'Unsere Mission',
    missionText: 'Als Bilgoo sind wir dazu verpflichtet, Bildung für jeden zugänglich, spielerisch und interaktiv zu machen. Durch unsere Quiz-basierte Lernumgebung unterstützen wir die Verbesserung der Wissenschätzungen unserer Benutzer und ihre persönliche Entwicklung.',
    whatIsTitle: 'Was ist Bilgoo?',
    whatIsText: 'Bilgoo ist die führende interaktive Trivia-Plattform in der Türkei. Im Jahr 2023 gegründet, bietet unsere Plattform innovative Lösungen im Bereich der Bildungstechnologie. Unsere Benutzer können ihre Kenntnisse durch Nutzung unseres umfangreichen Fragepools testen, mit ihren Freunden konkurrieren und ihren Lernprozess mit Gamifizierung unterstützen.',
    ...
    featurePoolText: 'Testen Sie Ihre Kenntnisse mit Tausenden von originellen Fragen über Allgemeinwissen, Wissenschaft, Geschichte, Geographie, Sport und viele andere Kategorien.',
    featureSocialTitle: 'Sozialer Wettbewerb',
    featureSocialText: 'Konkurrieren Sie mit Ihren Freunden, setzen Sie sich auf der Bestenliste und teilen Sie Ihre Erfolge.',
    featureProgressTitle: 'Fortschrittsverfolgung',
    ...
    featureMultiTitle: 'Mehrfachplattform',
    ...
    visionText: 'Zu einer führenden Plattform im Bereich der Bildungstechnologie in der Türkei und einem anerkannten Markenzeichen weltweit zu werden. Durch künstliche Intelligenz unterstützte persönliche Lernerfahrungen maximieren wir das Lernpotenzial aller Altersgruppen.',
    goalsTitle: 'Unsere Ziele',
    goal1: 'Bis Ende 2025 100.000 aktive Benutzer erreichen',
    goal2: 'Ein KI-gestütztes adaptives Lernsystem entwickeln',
    goal3: 'Partnerschaften mit Bildungseinrichtungen eingehen',
    goal4: 'Internationale Märkte erschließen',
    goal5: 'App-Downloads auf 500.000 erhöhen',
    goal6: 'Ein nachhaltiges Einnahmemodell mit einem Premium-Mitgliedschaftssystem schaffen',
    ...
    teamText2: '<strong>Teknova Bilişim</strong> Plattform unserer, konzentriert sich auf die ständige Verbesserung der Benutzererfahrung durch Forschung und Entwicklung.',
    qualityTitle: 'Qualität und Zuverlässigkeit',
    qualityIntro: 'Wir garantieren die höchste Qualität für unsere Benutzer:',
    quality1: 'Alle unsere Fragen werden von erfahrenen Lehrern vorbereitet und überprüft',
    quality2: 'Wir aktualisieren unseren Inhalt ständig, um sicherzustellen, dass wir aktuelle und akkurate Informationen liefern',
    quality3: 'Wir verbessern die Plattform ständig basierend auf Benutzerfeedback',
    quality4: 'Unsere technische Infrastruktur wird rund um die Uhr überwacht und optimiert',
    quality5: 'Unser Kundensupport-Team antwortet schnell auf Benutzeranfragen',
    ...
    social3: 'Wir tragen zu Open-Source-Bildungsprojekten bei',
    social4: 'Wir unterstützen digitale Alphabetisierungskampagnen',
