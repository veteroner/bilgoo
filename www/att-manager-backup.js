...
const ATTManager = {
    ...
    requestTrackingAuthorization: function() {
        return new Promise((resolve, reject) => {
            ...
            setTimeout(() => {
                console.log('[ATT Debug] Calling AppTrackingTransparency.requestTrackingAuthorization()');
    ...
    isATTPluginAvailable: function() {
        ...
        if (window.Capacitor?.Plugins?.AppTrackingTransparency) {
            ...
            console.log('[ATT Debug] Has getTrackingAuthorizationStatus:', typeof plugin.getTrackingAuthorizationStatus);
            console.log('[ATT Debug] Has requestTrackingAuthorization:', typeof plugin.requestTrackingAuthorization);
        }
